...
//		instance = new ConferenceServer(url, cache);
//		try {
...
//		RestClient.postObject(requestUrl.toString(), new Credential(user, decrypt), void.class);
...
//
//			result = RestClient.loadObjects(requestUrl.toString(), Conference.class);
//			if (result == null) {
...
//		if (create) {
//			conference = RestClient.createObject(requestUrl.toString(), conference, Conference.class);
//		} else {
//			requestUrl.append('/');
//			requestUrl.append(conference.getId());
//			conference = RestClient.updateObject(requestUrl.toString(), conference);
//		}
//		conferenceCache.add(conference);
//		return conference;
//	}
...
//			requestUrl.append("/session");
//			session = RestClient.createObject(requestUrl.toString(), session, Session.class);
...
//
//			result = RestClient.loadObjects(requestUrl.toString(), Author.class);
//			if (result == null) {
//				return new Author[0];
//			}
...
//		conferenceCache.removeObject(DataCache.LOCATION_CACHE_KEY, new ArrayList<Location>().getClass());
//		StringBuilder requestUrl = new StringBuilder();
//		requestUrl.append(baseUrl);
//		requestUrl.append("/location");
//
//		return RestClient.createObject(requestUrl.toString(), location, Location.class);
//	}
//
//	public Location[] getLocations() {
//		List<Location> result = conferenceCache.getObject(DataCache.LOCATION_CACHE_KEY, new ArrayList<Location>().getClass());
//		if (result == null || result.isEmpty()) {
//			StringBuilder requestUrl = new StringBuilder();
//			requestUrl.append(baseUrl);
//			requestUrl.append("/locations");
//
//			result = RestClient.loadObjects(requestUrl.toString(), Location.class);
//			if (result == null) {
//				return new Location[0];
//			}
//			conferenceCache.addObject(DataCache.LOCATION_CACHE_KEY, result);
//		}
...
//		conferenceCache.removeObject(DataCache.LABEL_CACHE_KEY, new ArrayList<String>().getClass());
//		StringBuilder requestUrl = new StringBuilder();
//		requestUrl.append(baseUrl);
//		requestUrl.append("/label");
//		// requestUrl.append(URLEncoder.encode(name));
//
//		RestClient.createObject(requestUrl.toString(), name, void.class);
//	}
//
//	public String[] getLabels() {
//		List<String> result = conferenceCache.getObject(DataCache.LABEL_CACHE_KEY, new ArrayList<String>().getClass());
//		if (result == null || result.isEmpty()) {
//			StringBuilder requestUrl = new StringBuilder();
//			requestUrl.append(baseUrl);
...
//			result = RestClient.loadCollection(requestUrl.toString(), collectionType);
//			if (result == null) {
//				return new String[0];
//			}
//			conferenceCache.addObject(DataCache.LABEL_CACHE_KEY, result);
//		}
...
//				.searchObjects(requestUrl.toString(), "sessions", Session.class, search);
//		if (result == null) {
...
//
//		RestClient.createObject(requestUrl.toString(), rate, int[].class);
//	}
//
...
//		requestUrl.append("/rating");
//
//		List<Integer> list = RestClient.loadObjects(requestUrl.toString(), int.class);
//		return new Rate(list);
//	}
//
//	public Remark[] getRemarks(Session session) {
//		String key = DataCache.REMARK_CACHE_KEY + session.getId();
...
//
//			result = RestClient.loadObjects(requestUrl.toString(), Remark.class);
//			if (result == null) {
//				return new Remark[0];
//			}
...
//		requestUrl.append("/comment");
//
//		RestClient.createObject(requestUrl.toString(), remark, Remark[].class);
//	}
