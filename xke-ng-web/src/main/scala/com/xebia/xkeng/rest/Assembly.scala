...
object Assembly  {
  ...
  private def createTestConference(startDate: DateTime) = {
	val p1 = Session("Mongo rocks", "amooi@xebia.com", "Mongo is a paperless document database")
	val p2 = Session("Scala rocks even more", "upeter@xebia.com", "Scala is a codeless programming language")
	val p3 = Session("Scala quirks", "upeter@xebia.com", "No such thing as a free ride when doing scala")
	p1.save
	p2.save
	p3.save
